...
const Modal = ({ children, closeModal, hasCloseButton = true }: ModalProps) => {
  return (
    <div className="fixed inset-0 z-[999] flex items-center justify-center">
      ...
      <div className="absolute left-1/2 top-1/2 z-[2] flex h-fit w-full -translate-x-1/2 -translate-y-1/2 flex-col rounded-2xl bg-white py-4 px-2 shadow-[4.4px_35px_32px_0_rgba(0,0,0,0.12)] max-md:max-w-[calc(100%-24px)] md:max-w-[600px]">
